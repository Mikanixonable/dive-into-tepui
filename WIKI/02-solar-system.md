...
太陽系は `CelestialSystem` の中で、太陽・惑星・衛星・準惑星・小天体を同じ天体系として束ねる。各天体は静的な定義、時刻から決まる運動、描画表現を分けて持ち、地球系・木星系などの構築関数を合成して一つの太陽系を作る。物理状態の基本座標は ECI に揃え、表示や軌道解析で必要なときだけ対象天体中心・回転系へ変換する。

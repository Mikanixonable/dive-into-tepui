...
// **あいだの数百 km の段(640〜270 km)は薄く取る** — 厚く取ると板が数百 km の斑に割れ、筋の向きも
// 斑ごとに揃って空の広い範囲で縞になる。ただし薄く取りすぎると 400〜1700 km の濃淡が抜けて板が
// 平坦な靄になり、合成の局所コントラストが落ちる — 取り分は両側から挟んだ値。いちばん細かい段は
...
const UPPER_HUMIDITY_NOISE: readonly NoiseOctave[] = [
  ...
  { frequency: 10, amplitude: 0.55 }, // 640 km
  { frequency: 24, amplitude: 0.35 }, // 270 km
  { frequency: 64, amplitude: 0.45 }, // 100 km
];

...
// 上昇流が上限値に達するため活発度も 1 へ飽和し、粒の振れ幅(伝達関数の幅の ±1.6 倍)がそのまま重畳する
// — 減衰させないと、帯が被覆率の立ち上がり閾値を跨ぐ境界部で、面構造が点描状に破綻する。塔は別の項が
...
// 上昇流が上限値(0.06 m/s)の谷の芯で 5.5 km、並の低気圧(0.02 m/s)で 2.7 km、上昇流の無い所で
...
// 漸近させる tanh の漸近飽和特性で、下地が常に e^−τ だけ透けることを保証する — 巻雲は不透明にならない。

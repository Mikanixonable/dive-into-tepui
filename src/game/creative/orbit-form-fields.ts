...
import type { CelestialBodyId, OrbitingId } from '../../physics/celestial-body';
...
export function orbitingIdsOf(registry: CelestialRegistry): readonly OrbitingId[] {
...
export function bodyGroupsOf(
  registry: CelestialRegistry, items: readonly (readonly [CelestialBodyId, string])[], selected: CelestialBodyId,
): readonly ObjectPickerGroup<CelestialBodyId>[] {
...
export function lagrangeSystemItemsOf(ephemeris: Ephemeris, orbitingIds: readonly OrbitingId[]): readonly (readonly [OrbitingId, string])[] {
...
export function primaryDistanceKm(secondary: OrbitingId): number {

...
export const FIRE_INTERVAL = 0.078; // 発射間隔 [s] (元の0.112の約0.7倍)
...
export const MAG_PICKUP_MAGS = 12; // 補給 1 個の取り込みで増えるマガジン数
...
export const AMMO_LOW_MAGS = 4; // 残りマガジンがこれ未満になると付近の軌道に補給を投入

...
export class PlanPanel {
  ...
  constructor(panelRoot: HTMLElement) {
    ...
    this.proInput = buildDvAxisInput(dvRow, 'PRO', AXIS_PROGRADE, onInputChange);
    this.nrmInput = buildDvAxisInput(dvRow, 'NRM', AXIS_NORMAL, onInputChange);
    this.radInput = buildDvAxisInput(dvRow, 'RAD', AXIS_RADIAL, onInputChange);
  ...
  sync(
    ...
    warnAtmosphere: boolean, hasSelection: boolean,
  ): void {

...
import { MarkerSlots, MARKER_DIR_DIST } from '../../render/marker/marker-slots';
import { DIRECTION_GLYPH, ORBIT_POINT_GLYPH, COLOR_MARKER_NODE } from '../../render/marker/marker-identity';

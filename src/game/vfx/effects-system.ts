...
export class EffectsSystem {
  ...
  spawnGasPuff(state: KinematicState): void {
    ...
    this.spawnFlash(state, 1.0, 8.0, 0.45, GAS_PUFF_COLOR_1, 0.3);
    this.spawnFlash(state, 0.5, 6.0, 0.35, GAS_PUFF_COLOR_2, 0.4);
  }

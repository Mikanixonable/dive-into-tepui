  ...
  private show(body: RunEventBody): void {
    switch (body.kind) {
      ...
      case 'gunFired':
        ...
        return;
      case 'gunSpunUp':
        this.worldSfx.spinUp();
        return;
      case 'gunDryFired':
        this.worldSfx.emptyClick();
        return;
      case 'gunMagazineFed':
        this.worldSfx.magFeed();
        return;
      case 'gunBarrelSwapped':
        this.worldSfx.playReload();
        return;
      case 'gunDisabled':
      ...
      case 'shipStruck':
        ...
        this.worldSfx.hit(len(sub(body.impactPoint, body.shipState.r)));
        return;
      case 'shipDamagedByContact':
      case 'enemyDamagedByContact':
      case 'casingContacted':
        this.worldSfx.clank();
        return;
      case 'enemyStruckByBullet':
        this.worldSfx.enemyHit();
        return;
      case 'shipExploded':
        this.worldSfx.explosion();
        return;
      case 'plasmaPassedClose':
        this.worldSfx.magneticInterference();
        return;
      case 'enemyDied':

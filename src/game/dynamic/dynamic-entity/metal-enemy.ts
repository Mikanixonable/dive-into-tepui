...
import {
  Enemy, ENEMY_SCALE, PLASMA_BULLET_DAMAGE, visualRadiusOf,
  type EnemyPlacement, type EnemyRestore,
} from './enemy';
...
export class MetalEnemy extends Enemy {
  ...
  public constructor(
    ...
    super(
      ...
      visualRadiusOf(renderObject), C.ENEMY_MAX_HP, worldSfx, fx, scene,
    );

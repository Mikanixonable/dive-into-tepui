...
// 惑星が主星のまわりに描く円軌道。平均黄経の進む速さは長半径と二体の重力定数が決める平均運動
// そのもので、ここを外すと軌道の速度と主星まわりの二体加速度が食い違う。
const ZEPHYRUS_ORBIT = planetOrbit({
  a: AU, e: 0, incDeg: 0, raanDeg: 0, lonPeriDeg: 0, l0Deg: 0,
  lRateDegPerCentury: (360 * JULIAN_CENTURY) / keplerPeriod(AU, STAR_MU + PRIMARY_MU),
  raanRateDegPerCentury: 0, incRateDegPerCentury: 0,

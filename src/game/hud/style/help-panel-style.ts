...
#hud-help .help-quickstart { padding: var(--space-4); border: 0; background: var(--color-primary-fill-weak); }
...
#hud-help .help-recipe {
  ...
  background: var(--surface-1); color: var(--text); font-size: var(--font-xxs);
}
...
#hud-help kbd, #hud-help .help-entry-key {
  ...
  padding: 0 var(--space-2); border: 0; border-radius: var(--radius-micro);
...
#hud-help .help-keyboard { display: grid; gap: 3px; padding: var(--space-3); border: 0; background: var(--surface-0); }
#hud-help .help-keyboard-row { display: flex; gap: 3px; }
#hud-help .help-key {
  flex: 1 1 0; min-width: 0; height: 30px; padding: 0 2px; overflow: hidden; border: 0;
  border-radius: var(--radius-micro); background: var(--surface-1); color: var(--text-faint); font: inherit; font-size: var(--font-xxs);
  cursor: pointer; transition: background var(--transition-fast), color var(--transition-fast), transform var(--transition-fast);
}
#hud-help .help-key.wide { flex-grow: 1.55; }
#hud-help .help-key.xwide { flex-grow: 2.1; }
#hud-help .help-key.space { flex-grow: 5.2; }
#hud-help .help-key.mapped { color: var(--text); }
...
#hud-help .help-group { border: 0; background: var(--surface-1); }
...
#hud-help .help-behavior, #hud-help .help-input-tag { padding: 1px var(--space-2); border: 0; color: var(--text-dim); font-size: 9px; letter-spacing: .04em; white-space: nowrap; }
#hud-help .help-behavior { color: var(--color-warning); }
#hud-help .help-input-tag.input-keyboard { color: var(--color-info); }
#hud-help .help-input-tag.input-mouse { color: var(--color-success); }
#hud-help .help-input-tag.input-touch { color: var(--color-signal); }

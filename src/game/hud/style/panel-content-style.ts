...
#hud-halo-orbit { width: 100%; pointer-events: auto; }
...
#hud-halo-orbit .halo-amplitude-row .slider-col { flex: 1 1 60px; min-width: 60px; }
...
#hud-halo-orbit .halo-amplitude-row .w-input { width: 60px; }

...
#hud-stagestatus {
  ...
  text-align: left; min-width: 624px; padding: var(--space-4) var(--space-6);
}
#hud-stagestatus .t {
...
#hud-stagestatus .t .w-meter { width: 208px; }
...
@media ${MQ_MEDIUM_DOWN} {
  ...
  #hud-stagestatus { bottom: 8px; width: min(80vw, 572px); min-width: 0; max-height: 62px; overflow-y: auto; padding: var(--space-3) var(--space-5); gap: var(--space-4); }

...
// 換装した瞬間に推力や耐久が別物になる。
const DEFAULT_TORQUE = MAX_ANG_ACCEL * Math.max(PLAYER_INERTIA_PITCH, PLAYER_INERTIA_YAW, PLAYER_INERTIA_ROLL);
const DEFAULT_THRUST = PLAYER_MASS * THROTTLE_LEVELS[THROTTLE_LEVELS.length - 1]!;

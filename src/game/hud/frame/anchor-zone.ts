...
export class AnchorZone {
  ...
  public setItems(pickables: readonly ListedObject[], includeAllCelestialBodies = false): void {
  ...
  public setNearby(members: readonly string[], pickables: readonly ListedObject[]): void {

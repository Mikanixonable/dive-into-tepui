...
function buildHelpTableHtml(): string {
  return `
    ...
    <table>
      ...
      <tr><td class="key">太陽系パネル</td><td>マップモード左上。天体・機体・星空、天球固定の黄道/赤道グリッド、3D空間に浮かぶ黄道面/赤道面/月軌道面の縮尺グリッドを切り替える(初期状態は閉じている。縮尺はズームに合わせて変化)</td></tr>
      <tr><td class="key">カメラ / 軌道パネル</td><td>カメラの注視対象・回転系と、計画軌道の描画基準を別々に設定する。カメラパネルでは回転操作(クォータニオン/オイラー)、画角、画角リセット、透視/平行投影、黄道面・赤道面・月軌道面からの真上/真横視点も選べる</td></tr>

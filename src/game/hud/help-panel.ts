...
function buildHelpTableHtml(): string {
  return `
    ...
    <table>
      ...
      <tr><td class="key">太陽系パネル</td><td>マップモード左上。天体・機体・参照面の表示切替を行う</td></tr>
      <tr><td class="key">カメラ / 軌道パネル</td><td>カメラの注視対象・回転系と、計画軌道の描画基準を別々に設定する。カメラパネルでは回転操作(クォータニオン/オイラー)、画角、黄道面・赤道面・月軌道面からの真上/真横視点も選べる</td></tr>

...
#hud .hud-map-root.active #hud-object-list,
...
#hud .hud-map-root.active #hud-object-list h3,
...
#hud .hud-map-root.active #hud-object-list { max-height: min(576px, 64dvh); }
#hud .hud-map-root.active #hud-object-list .object-list-head {
  background: color-mix(in srgb, var(--surface-1) 86%, transparent);
  border-radius: var(--radius-panel) var(--radius-panel) 0 0;
  backdrop-filter: blur(18px) saturate(82%);
  -webkit-backdrop-filter: blur(18px) saturate(82%);
}
#hud .hud-map-root.active #hud-object-list .object-list-search { padding: 0 0 var(--space-2); }
#hud .hud-map-root.active #hud-object-list .object-list-search .w-input {
  min-height: 30px;
  border: 0;
  border-radius: var(--radius-control);
...
#hud .hud-map-root.active #hud-object-list .object-list-head .w-group {
  display: grid;
  grid-template-columns: 48px minmax(0, 1fr);
  gap: var(--space-2);
  padding: var(--space-1) 0;
}
#hud .hud-map-root.active #hud-object-list .object-list-head .w-group-title {
  min-width: 0;
  color: var(--muted);
  letter-spacing: 0;
}
#hud .hud-map-root.active #hud-object-list .object-list-head .w-btn {
  border: 0;
  border-radius: var(--radius-control);
  background: transparent;
}
#hud .hud-map-root.active #hud-object-list .object-list-head .w-btn:hover { color: var(--accent-near); background: var(--surface-2); }
#hud .hud-map-root.active #hud-object-list .object-list-head .w-btn.on { color: var(--accent); background: var(--surface-2); }
#hud .hud-map-root.active #hud-object-list .object-list-breadcrumb {
...
#hud .hud-map-root.active #hud-object-list .object-list-section-header {
  border: 0;
  border-radius: var(--radius-control);
  color: var(--body);
  background: transparent;
...
#hud .hud-map-root.active #hud-object-list .object-list-section-header:hover { color: var(--accent-near); background: var(--surface-2); }
#hud .hud-map-root.active #hud-object-list .object-list-section-header:focus-visible { outline: 2px solid var(--accent); outline-offset: -2px; }
#hud .hud-map-root.active #hud-object-list .erow {
  min-height: 28px;
  border-radius: var(--radius-control);
  color: var(--muted);
  transition: color var(--transition-fast), background var(--transition-fast);
}
#hud .hud-map-root.active #hud-object-list .erow:hover { color: var(--title); background: var(--surface-2); }
#hud .hud-map-root.active #hud-object-list .erow.related-orbit { color: var(--accent-near); }
#hud .hud-map-root.active #hud-object-list .erow.on {
  outline: 0;
  color: var(--accent);
  background: color-mix(in srgb, var(--accent) 12%, transparent);
}
#hud .hud-map-root.active #hud-object-list .erow:focus-visible { outline: 2px solid var(--accent); outline-offset: -2px; }
#hud .hud-map-root.active #hud-object-list .object-list-glyph {
  flex: 0 0 16px;
  color: currentColor;
  text-align: center;
...
#hud .hud-map-root.active #hud-view-options .view-options-section-collapse {
  background: none; border: none; color: var(--text-dim); font: inherit; cursor: pointer; pointer-events: auto;
}
#hud .hud-map-root.active #hud-view-options .view-options-section.collapsed { display: none; }
...
@media ${MQ_MEDIUM_DOWN} {
  ...
  #hud .hud-map-root.active #hud-view-options .view-options-section-heading { grid-template-columns: 82px minmax(0, 1fr) 20px; }
...
@media ${MQ_COMPACT} {
  ...
  #hud .hud-map-root.active #hud-object-list .object-list-head .w-group-title,
  #hud .hud-map-root.active #hud-object-list .object-list-detail { font-size: 8px; }
  #hud .hud-map-root.active #hud-view-options .view-options-section-heading { grid-template-columns: 68px minmax(0, 1fr) 20px; }

...
.mk-apsis .sym, .mk-node .sym, .mk-mnode .sym, .mk-burn .sym, .mk-planned .sym { font-size: calc(var(--glyph-base) * 0.5); }
.mk-apsis .sym svg, .mk-node .sym svg, .mk-mnode .sym svg, .mk-burn .sym svg, .mk-planned .sym svg { width: 50%; height: 50%; }

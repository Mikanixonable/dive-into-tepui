...
// 天王星系の天体の表示名。
export const URANUS_SYSTEM_NAMES: { readonly [K in keyof UranusSystemMotions]: string } = {
  uranus: '天王星',
  puck: 'パック',
  miranda: 'ミランダ',
  ariel: 'アリエル',
...
export function uranusSystemEntities(
  ...
  return {
    uranus: new PointEntity(
      m.uranus, URANUS_SYSTEM_NAMES.uranus, 'planet',

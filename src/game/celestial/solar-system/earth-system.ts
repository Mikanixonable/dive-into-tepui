...
// 殻、どれもアルベド 0.8)が覆う 0.2760 ぶんを A_B=0.306 から引いた残りを、雲に覆われずに残る
// 地表の平均輝度 0.08197 へ割り当てる値。averageHue はその合成の色み。平均はどれもテクスチャ上を
// 緯度余弦で重み付けて測る(不透明な積雲 0.1361・巻雲 0.1056・中間調 0.0343 の順に覆う)。
export const EARTH_TEXTURE: CelestialTexture = {
  url: earthTextureUrl,
  albedoScale: 1.0391,
  bondAlbedo: 0.306,
  averageHue: [0.9649, 0.9931, 1.1720],
};

...
import { GRAVITATIONAL_CONSTANT, MU_SUN } from '../../../physics/solar-system/constants';
...
export function smallBodies(
  ...
  return {
    ...
    halley: new SphereEntity(
      new PlanetMotion(HALLEY, sun, phases[HALLEY.id] ?? 0, epochOffsetSec, pack, origin),
    ...
    encke: new SphereEntity(
      new PlanetMotion(ENCKE, sun, phases[ENCKE.id] ?? 0, epochOffsetSec, pack, origin),
    ...
    sedna: new SphereEntity(
      new PlanetMotion(SEDNA, sun, phases[SEDNA.id] ?? 0, epochOffsetSec, pack, origin),
    ...
    weywot: new SphereEntity(
      new SatelliteMotion(WEYWOT, quaoar, phases[WEYWOT.id] ?? 0, epochOffsetSec, pack, origin),
    ...
    chariklo: new SphereEntity(
      new PlanetMotion(CHARIKLO, sun, phases[CHARIKLO.id] ?? 0, epochOffsetSec, pack, origin),
    ...
    hygiea: new SphereEntity(
      new PlanetMotion(HYGIEA, sun, phases[HYGIEA.id] ?? 0, epochOffsetSec, pack, origin),
    ...
    eros: new SphereEntity(
      new PlanetMotion(EROS, sun, phases[EROS.id] ?? 0, epochOffsetSec, pack, origin),
    ...
    ryugu: new SphereEntity(
      new PlanetMotion(RYUGU, sun, phases[RYUGU.id] ?? 0, epochOffsetSec, pack, origin),
    ...
    bennu: new SphereEntity(
      new PlanetMotion(BENNU, sun, phases[BENNU.id] ?? 0, epochOffsetSec, pack, origin),
    ...
    vanth: new SphereEntity(
      new SatelliteMotion(VANTH, orcus, phases[VANTH.id] ?? 0, epochOffsetSec, pack, origin),
    ...
    gonggong: new SphereEntity(
      new PlanetMotion(GONGGONG, sun, phases[GONGGONG.id] ?? 0, epochOffsetSec, pack, origin),
    ...
    salacia: new SphereEntity(
      new PlanetMotion(SALACIA, sun, phases[SALACIA.id] ?? 0, epochOffsetSec, pack, origin),
    ...
    varuna: new SphereEntity(
      new PlanetMotion(VARUNA, sun, phases[VARUNA.id] ?? 0, epochOffsetSec, pack, origin),
    ...
    ixion: new SphereEntity(
      new PlanetMotion(IXION, sun, phases[IXION.id] ?? 0, epochOffsetSec, pack, origin),
    ...
    arrokoth: new SphereEntity(
      new PlanetMotion(ARROKOTH, sun, phases[ARROKOTH.id] ?? 0, epochOffsetSec, pack, origin),
    ...
    chiron: new SphereEntity(
      new PlanetMotion(CHIRON, sun, phases[CHIRON.id] ?? 0, epochOffsetSec, pack, origin),
    ...
    interamnia: new SphereEntity(
      new PlanetMotion(INTERAMNIA, sun, phases[INTERAMNIA.id] ?? 0, epochOffsetSec, pack, origin),
    ...
    europa52: new SphereEntity(
      new PlanetMotion(EUROPA52, sun, phases[EUROPA52.id] ?? 0, epochOffsetSec, pack, origin),
    ...
    davida: new SphereEntity(
      new PlanetMotion(DAVIDA, sun, phases[DAVIDA.id] ?? 0, epochOffsetSec, pack, origin),
    ...
    juno: new SphereEntity(
      new PlanetMotion(JUNO, sun, phases[JUNO.id] ?? 0, epochOffsetSec, pack, origin),
    ...
    psyche: new SphereEntity(
      new PlanetMotion(PSYCHE, sun, phases[PSYCHE.id] ?? 0, epochOffsetSec, pack, origin),
    ...
    eunomia: new SphereEntity(
      new PlanetMotion(EUNOMIA, sun, phases[EUNOMIA.id] ?? 0, epochOffsetSec, pack, origin),
    ...
    sylvia: new SphereEntity(
      new PlanetMotion(SYLVIA, sun, phases[SYLVIA.id] ?? 0, epochOffsetSec, pack, origin),
    ...
    apophis: new SphereEntity(
      new PlanetMotion(APOPHIS, sun, phases[APOPHIS.id] ?? 0, epochOffsetSec, pack, origin),
    ...
    didymos: new SphereEntity(
      new PlanetMotion(DIDYMOS, sun, phases[DIDYMOS.id] ?? 0, epochOffsetSec, pack, origin),
    ...
    tempel1: new SphereEntity(
      new PlanetMotion(TEMPEL1, sun, phases[TEMPEL1.id] ?? 0, epochOffsetSec, pack, origin),
    ...
    wild2: new SphereEntity(
      new PlanetMotion(WILD2, sun, phases[WILD2.id] ?? 0, epochOffsetSec, pack, origin),
    ...
    hartley2: new SphereEntity(
      new PlanetMotion(HARTLEY2, sun, phases[HARTLEY2.id] ?? 0, epochOffsetSec, pack, origin),
    ...
    cruithne: new SphereEntity(
      new PlanetMotion(CRUITHNE, sun, phases[CRUITHNE.id] ?? 0, epochOffsetSec, pack, origin),
    ...
    kamooalewa: new SphereEntity(
      new PlanetMotion(KAMOOALEWA, sun, phases[KAMOOALEWA.id] ?? 0, epochOffsetSec, pack, origin),
    ...
    tk7: new SphereEntity(
      new PlanetMotion(TK7, sun, phases[TK7.id] ?? 0, epochOffsetSec, pack, origin),
    ...
    eureka: new SphereEntity(
      new PlanetMotion(EUREKA, sun, phases[EUREKA.id] ?? 0, epochOffsetSec, pack, origin),

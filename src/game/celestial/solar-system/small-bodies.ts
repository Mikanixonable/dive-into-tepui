...
export function smallBodies(
  ...
  const quaoar = planetSystem(planetDefAtEpoch(QUAOAR, phases, epochOffsetSec), sun, pack);
  const orcus = planetSystem(planetDefAtEpoch(ORCUS, phases, epochOffsetSec), sun, pack);
  return {
    // ハレー彗星 A_B=0.016(幾何 0.04 x q=0.393)
    halley: new SphereEntity(
      planetSystem(planetDefAtEpoch(HALLEY, phases, epochOffsetSec), sun, pack).body,
    ...
    encke: new SphereEntity(
      planetSystem(planetDefAtEpoch(ENCKE, phases, epochOffsetSec), sun, pack).body,
    ...
    sedna: new SphereEntity(
      planetSystem(planetDefAtEpoch(SEDNA, phases, epochOffsetSec), sun, pack).body,
    ...
    weywot: new SphereEntity(
      new SatelliteMotion(satelliteDefAtEpoch(WEYWOT, phases, epochOffsetSec), quaoar, pack),
    ...
    chariklo: new SphereEntity(
      planetSystem(planetDefAtEpoch(CHARIKLO, phases, epochOffsetSec), sun, pack).body,
    ...
    hygiea: new SphereEntity(
      planetSystem(planetDefAtEpoch(HYGIEA, phases, epochOffsetSec), sun, pack).body,
    ...
    eros: new SphereEntity(
      planetSystem(planetDefAtEpoch(EROS, phases, epochOffsetSec), sun, pack).body,
    ...
    ryugu: new SphereEntity(
      planetSystem(planetDefAtEpoch(RYUGU, phases, epochOffsetSec), sun, pack).body,
    ...
    bennu: new SphereEntity(
      planetSystem(planetDefAtEpoch(BENNU, phases, epochOffsetSec), sun, pack).body,
    ...
    vanth: new SphereEntity(
      new SatelliteMotion(satelliteDefAtEpoch(VANTH, phases, epochOffsetSec), orcus, pack),
    ...
    gonggong: new SphereEntity(
      planetSystem(planetDefAtEpoch(GONGGONG, phases, epochOffsetSec), sun, pack).body,
    ...
    salacia: new SphereEntity(
      planetSystem(planetDefAtEpoch(SALACIA, phases, epochOffsetSec), sun, pack).body,
    ...
    varuna: new SphereEntity(
      planetSystem(planetDefAtEpoch(VARUNA, phases, epochOffsetSec), sun, pack).body,
    ...
    ixion: new SphereEntity(
      planetSystem(planetDefAtEpoch(IXION, phases, epochOffsetSec), sun, pack).body,
    ...
    arrokoth: new SphereEntity(
      planetSystem(planetDefAtEpoch(ARROKOTH, phases, epochOffsetSec), sun, pack).body,
    ...
    chiron: new SphereEntity(
      planetSystem(planetDefAtEpoch(CHIRON, phases, epochOffsetSec), sun, pack).body,
    ...
    interamnia: new SphereEntity(
      planetSystem(planetDefAtEpoch(INTERAMNIA, phases, epochOffsetSec), sun, pack).body,
    ...
    europa52: new SphereEntity(
      planetSystem(planetDefAtEpoch(EUROPA52, phases, epochOffsetSec), sun, pack).body,
    ...
    davida: new SphereEntity(
      planetSystem(planetDefAtEpoch(DAVIDA, phases, epochOffsetSec), sun, pack).body,
    ...
    juno: new SphereEntity(
      planetSystem(planetDefAtEpoch(JUNO, phases, epochOffsetSec), sun, pack).body,
    ...
    psyche: new SphereEntity(
      planetSystem(planetDefAtEpoch(PSYCHE, phases, epochOffsetSec), sun, pack).body,
    ...
    eunomia: new SphereEntity(
      planetSystem(planetDefAtEpoch(EUNOMIA, phases, epochOffsetSec), sun, pack).body,
    ...
    sylvia: new SphereEntity(
      planetSystem(planetDefAtEpoch(SYLVIA, phases, epochOffsetSec), sun, pack).body,
    ...
    apophis: new SphereEntity(
      planetSystem(planetDefAtEpoch(APOPHIS, phases, epochOffsetSec), sun, pack).body,
    ...
    didymos: new SphereEntity(
      planetSystem(planetDefAtEpoch(DIDYMOS, phases, epochOffsetSec), sun, pack).body,
    ...
    tempel1: new SphereEntity(
      planetSystem(planetDefAtEpoch(TEMPEL1, phases, epochOffsetSec), sun, pack).body,
    ...
    wild2: new SphereEntity(
      planetSystem(planetDefAtEpoch(WILD2, phases, epochOffsetSec), sun, pack).body,
    ...
    hartley2: new SphereEntity(
      planetSystem(planetDefAtEpoch(HARTLEY2, phases, epochOffsetSec), sun, pack).body,
    ...
    cruithne: new SphereEntity(
      planetSystem(planetDefAtEpoch(CRUITHNE, phases, epochOffsetSec), sun, pack).body,
    ...
    kamooalewa: new SphereEntity(
      planetSystem(planetDefAtEpoch(KAMOOALEWA, phases, epochOffsetSec), sun, pack).body,
    ...
    tk7: new SphereEntity(
      planetSystem(planetDefAtEpoch(TK7, phases, epochOffsetSec), sun, pack).body,
    ...
    eureka: new SphereEntity(
      planetSystem(planetDefAtEpoch(EUREKA, phases, epochOffsetSec), sun, pack).body,

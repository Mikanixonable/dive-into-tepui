...
export function smallBodies(
  ...
  return {
    ...
    weywot: new SphereEntity(
      new SatelliteMotion(satelliteDefAtEpoch(WEYWOT, phases, epochOffsetSec), quaoar, pack, origin),
    ...
    vanth: new SphereEntity(
      new SatelliteMotion(satelliteDefAtEpoch(VANTH, phases, epochOffsetSec), orcus, pack, origin),

...
export function jupiterSystem(
  ...
  return {
    ...
    metis: new SphereEntity(
      new SatelliteMotion(METIS, jupiter, phases[METIS.id] ?? 0, epochOffsetSec, pack, origin),
    ...
    adrastea: new SphereEntity(
      new SatelliteMotion(ADRASTEA, jupiter, phases[ADRASTEA.id] ?? 0, epochOffsetSec, pack, origin),
    ...
    amalthea: new SphereEntity(
      new SatelliteMotion(AMALTHEA, jupiter, phases[AMALTHEA.id] ?? 0, epochOffsetSec, pack, origin),
    ...
    thebe: new SphereEntity(
      new SatelliteMotion(THEBE, jupiter, phases[THEBE.id] ?? 0, epochOffsetSec, pack, origin),
      JUPITER_SYSTEM_NAMES.thebe, 'satellite', CelestialSurface.solid([0.0214, 0.0174, 0.0145]),
    ),
    io: new SphereEntity(
      new SatelliteMotion(IO, jupiter, phases[IO.id] ?? 0, epochOffsetSec, pack, origin),
    ...
    europa: new SphereEntity(
      new SatelliteMotion(EUROPA, jupiter, phases[EUROPA.id] ?? 0, epochOffsetSec, pack, origin),
    ...
    ganymede: new SphereEntity(
      new SatelliteMotion(GANYMEDE, jupiter, phases[GANYMEDE.id] ?? 0, epochOffsetSec, pack, origin),
    ...
    callisto: new SphereEntity(
      new SatelliteMotion(CALLISTO, jupiter, phases[CALLISTO.id] ?? 0, epochOffsetSec, pack, origin),
    ...
    himalia: new SphereEntity(
      new SatelliteMotion(HIMALIA, jupiter, phases[HIMALIA.id] ?? 0, epochOffsetSec, pack, origin),
    ...
    elara: new SphereEntity(
      new SatelliteMotion(ELARA, jupiter, phases[ELARA.id] ?? 0, epochOffsetSec, pack, origin),
    ...
    ananke: new SphereEntity(
      new SatelliteMotion(ANANKE, jupiter, phases[ANANKE.id] ?? 0, epochOffsetSec, pack, origin),
    ...
    carme: new SphereEntity(
      new SatelliteMotion(CARME, jupiter, phases[CARME.id] ?? 0, epochOffsetSec, pack, origin),
    ...
    pasiphae: new SphereEntity(
      new SatelliteMotion(PASIPHAE, jupiter, phases[PASIPHAE.id] ?? 0, epochOffsetSec, pack, origin),
    ...
    sinope: new SphereEntity(
      new SatelliteMotion(SINOPE, jupiter, phases[SINOPE.id] ?? 0, epochOffsetSec, pack, origin),

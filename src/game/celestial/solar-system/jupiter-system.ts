...
export function jupiterSystem(
  ...
  return {
    ...
    metis: new SphereEntity(
      new SatelliteMotion(satelliteDefAtEpoch(METIS, phases, epochOffsetSec), jupiter, pack, origin),
    ...
    adrastea: new SphereEntity(
      new SatelliteMotion(satelliteDefAtEpoch(ADRASTEA, phases, epochOffsetSec), jupiter, pack, origin),
    ...
    amalthea: new SphereEntity(
      new SatelliteMotion(satelliteDefAtEpoch(AMALTHEA, phases, epochOffsetSec), jupiter, pack, origin),
    ...
    thebe: new SphereEntity(
      new SatelliteMotion(satelliteDefAtEpoch(THEBE, phases, epochOffsetSec), jupiter, pack, origin),
      JUPITER_SYSTEM_NAMES.thebe, 'satellite', CelestialSurface.solid([0.0214, 0.0174, 0.0145]),
    ),
    io: new SphereEntity(
      new SatelliteMotion(satelliteDefAtEpoch(IO, phases, epochOffsetSec), jupiter, pack, origin),
    ...
    europa: new SphereEntity(
      new SatelliteMotion(satelliteDefAtEpoch(EUROPA, phases, epochOffsetSec), jupiter, pack, origin),
    ...
    ganymede: new SphereEntity(
      new SatelliteMotion(satelliteDefAtEpoch(GANYMEDE, phases, epochOffsetSec), jupiter, pack, origin),
    ...
    callisto: new SphereEntity(
      new SatelliteMotion(satelliteDefAtEpoch(CALLISTO, phases, epochOffsetSec), jupiter, pack, origin),
    ...
    himalia: new SphereEntity(
      new SatelliteMotion(satelliteDefAtEpoch(HIMALIA, phases, epochOffsetSec), jupiter, pack, origin),
    ...
    elara: new SphereEntity(
      new SatelliteMotion(satelliteDefAtEpoch(ELARA, phases, epochOffsetSec), jupiter, pack, origin),
    ...
    ananke: new SphereEntity(
      new SatelliteMotion(satelliteDefAtEpoch(ANANKE, phases, epochOffsetSec), jupiter, pack, origin),
    ...
    carme: new SphereEntity(
      new SatelliteMotion(satelliteDefAtEpoch(CARME, phases, epochOffsetSec), jupiter, pack, origin),
    ...
    pasiphae: new SphereEntity(
      new SatelliteMotion(satelliteDefAtEpoch(PASIPHAE, phases, epochOffsetSec), jupiter, pack, origin),
    ...
    sinope: new SphereEntity(
      new SatelliteMotion(satelliteDefAtEpoch(SINOPE, phases, epochOffsetSec), jupiter, pack, origin),

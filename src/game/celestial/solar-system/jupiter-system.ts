...
export function jupiterSystemEntities(
  ...
  return {
    ...
    metis: new SphereEntity(m.metis, 'メティス', 'satellite', CelestialSurface.solid([0.0285, 0.0231, 0.0193])),
    // アドラステア A_B=0.039(幾何 0.10 x q=0.393)
    adrastea: new SphereEntity(m.adrastea, 'アドラステア', 'satellite', CelestialSurface.solid([0.0463, 0.0376, 0.0314])),
    // アマルテア A_B=0.035(幾何 0.090 x q=0.393)
    amalthea: new SphereEntity(m.amalthea, 'アマルテア', 'satellite', CelestialSurface.solid([0.0673, 0.0271, 0.0181])),
    // テーベ A_B=0.018(幾何 0.047 x q=0.393)
    thebe: new SphereEntity(m.thebe, 'テーベ', 'satellite', CelestialSurface.solid([0.0214, 0.0174, 0.0145])),
    io: new SphereEntity(
      m.io, 'イオ', 'satellite',
    ...
    himalia: new SphereEntity(m.himalia, 'ヒマリア', 'satellite', CelestialSurface.solid([0.0190, 0.0156, 0.0114])),
    // エララ A_B=0.016(分類既定 幾何 0.04 x q=0.393)
    elara: new SphereEntity(m.elara, 'エララ', 'satellite', CelestialSurface.solid([0.0206, 0.0151, 0.0108])),
    // アナンケ A_B=0.016(分類既定 幾何 0.04 x q=0.393)
    ananke: new SphereEntity(m.ananke, 'アナンケ', 'satellite', CelestialSurface.solid([0.0188, 0.0156, 0.0121])),
    // カルメ A_B=0.016(分類既定 幾何 0.04 x q=0.393)
    carme: new SphereEntity(m.carme, 'カルメ', 'satellite', CelestialSurface.solid([0.0190, 0.0154, 0.0129])),
    // パシファエ A_B=0.016(分類既定 幾何 0.04 x q=0.393)
    pasiphae: new SphereEntity(m.pasiphae, 'パシファエ', 'satellite', CelestialSurface.solid([0.0197, 0.0153, 0.0116])),
    // シノーペ A_B=0.016(分類既定 幾何 0.04 x q=0.393)
    sinope: new SphereEntity(m.sinope, 'シノーペ', 'satellite', CelestialSurface.solid([0.0203, 0.0152, 0.0112])),
  };
}

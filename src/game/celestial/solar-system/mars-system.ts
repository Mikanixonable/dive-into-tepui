...
const MARS_ATMOSPHERE_OPTICS: AtmosphereOptics = {
...
export function marsSystemEntities(
  ...
  return {
    mars: new PointEntity(
      ...
      CelestialSurface.textured({ url: marsTextureUrl, albedoScale: 1.3663, bondAlbedo: 0.25, averageHue: [2.6054, 0.5946, 0.2888] }),
      MARS_ATMOSPHERE_OPTICS,
    ),

...
export function saturnSystemEntities(
  ...
  return {
    ...
    daphnis: new SphereEntity(m.daphnis, 'ダフニス', 'satellite', CelestialSurface.solid([0.3326, 0.2699, 0.2252])),
    // プロメテウス A_B=0.34(幾何 0.6 x q=0.564)
    prometheus: new SphereEntity(m.prometheus, 'プロメテウス', 'satellite', CelestialSurface.solid([0.3956, 0.3294, 0.2814])),
    // パンドラ A_B=0.34(幾何 0.6 x q=0.564)
    pandora: new SphereEntity(m.pandora, 'パンドラ', 'satellite', CelestialSurface.solid([0.3956, 0.3294, 0.2814])),
    // エピメテウス A_B=0.41(幾何 0.73 x q=0.564)
    epimetheus: new SphereEntity(m.epimetheus, 'エピメテウス', 'satellite', CelestialSurface.solid([0.4694, 0.3987, 0.3469])),
    // ヤヌス A_B=0.4(幾何 0.71 x q=0.564)
    janus: new SphereEntity(m.janus, 'ヤヌス', 'satellite', CelestialSurface.solid([0.4580, 0.3890, 0.3385])),
    // ミマス A_B=0.54(幾何 0.962 x q=0.564)
    mimas: new SphereEntity(m.mimas, 'ミマス', 'satellite', CelestialSurface.solid([0.5631, 0.5382, 0.4903])),
    // エンケラドゥス A_B=0.81(公表ボンド 0.81(幾何は 1.375))
    enceladus: new SphereEntity(m.enceladus, 'エンケラドゥス', 'satellite', CelestialSurface.solid([0.8249, 0.8089, 0.7774])),
    // テティス A_B=0.69(幾何 1.229 x q=0.564)
    tethys: new SphereEntity(m.tethys, 'テティス', 'satellite', CelestialSurface.solid([0.7185, 0.6877, 0.6284])),
    // ディオネ A_B=0.56(幾何 0.998 x q=0.564)
    dione: new SphereEntity(m.dione, 'ディオネ', 'satellite', CelestialSurface.solid([0.5844, 0.5580, 0.5074])),
    // レア A_B=0.54(幾何 0.949 x q=0.564)
    rhea: new SphereEntity(m.rhea, 'レア', 'satellite', CelestialSurface.solid([0.5622, 0.5382, 0.4920])),
    titan: new SphereEntity(
      m.titan, 'タイタン', 'satellite',
    ...
    hyperion: new SphereEntity(m.hyperion, 'ヒペリオン', 'satellite', CelestialSurface.solid([0.1617, 0.1375, 0.1009])),
    // イアペトゥス A_B=0.12(幾何は明暗半球で 0.05-0.5。全球平均 0.27 x q=0.461)
    iapetus: new SphereEntity(m.iapetus, 'イアペトゥス', 'satellite', CelestialSurface.solid([0.1296, 0.1189, 0.1023])),
    // フェーベ A_B=0.024(幾何 0.06 x q=0.393)
    phoebe: new SphereEntity(m.phoebe, 'フェーベ', 'satellite', CelestialSurface.solid([0.0276, 0.0234, 0.0196])),
  };
}

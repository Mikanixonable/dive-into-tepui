...
import { earthAltitudeOf } from '../../physics/solar-system';
...
import { Gunnery } from '../vessel/gunnery';
...
import {
  baseAssemblyFromSaveData, orbitalBaseDesign,
  type VesselFaction,
} from './vessel-designs';
import {
  resolveDesign, resolveIdentity, serializeAssembly,
  type VesselDeps, type VesselInit,
} from './vessel-identity';

export type { PlanExecutionMode };
export type {
  CrewedShipInit, BlueprintShipInit, OrbitalBaseInit, HostileShipInit, VesselInit, VesselDeps,
} from './vessel-identity';

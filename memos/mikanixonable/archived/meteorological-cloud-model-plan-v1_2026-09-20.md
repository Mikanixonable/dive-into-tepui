...
> **状態 — 第二版により置換 / 2026-09-23 整理:** 第一版で「実装済み」とした temporal LOD と実時間ベイク制限は、その後の設計変更で撤去された。現行の雲モデル計画は `../meteorological-cloud-model-plan-v2_2026-09-22.md` を参照する。このファイルは 2026-09-20 時点の設計履歴として保存する。

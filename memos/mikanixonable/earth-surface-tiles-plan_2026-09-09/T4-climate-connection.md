...
コード実装は `e195d4df`, `ac919b93`, `ea6d47a3`, `22532275` で完了した。UTC月時計、地表と
気候mapの共有楕円体UV、雲場・雲影・大気への同一投影、GSHHG陸地被覆率による水域判定、
旧Earth気候画像経路の除去を実装し、render 96/96、game 201/201を通過している。
実ERA5入力を焼いた12枚の本番mapと実ブラウザ/WebGPUでの標識一致は、入力データと実行環境が
揃うまで未実施として扱う。

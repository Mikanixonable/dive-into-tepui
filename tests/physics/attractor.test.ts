...
export function register(): void {
  ...
  test('attractor: attractorAccel は距離ゼロの天体(自分自身)で発散しない', () => {
    ...
    // μ/0³ で発散する。
    const coincidentMoon: Attractor = { id: 'moon', mu: MU_MOON, radius: R_MOON, state: kinematicState(0, r, ZERO), degree2: null, isStar: false };
  ...
  test('attractor: orbitalElementsOf が中心天体を伝え、月中心の tofBetween が MU_MOON 基準の周期と一致する(回帰)', () => {
    ...
    const moon: Attractor = {
      id: 'moon', mu: MU_MOON, radius: R_MOON, degree2: null, isStar: false,

...
└── Game
    ...
    │   ├── CelestialBody[]             ... CELESTIAL_BODIES(celestial-registry.ts)から1体ずつ生成。地球=EarthBody・太陽=SunBody・月/木星/土星等の他惑星=SphereBody(土星・天王星・海王星は build 時に buildRing 引数で環メッシュを本体の子として追加)
